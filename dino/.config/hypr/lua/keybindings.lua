...
-- WINDOWS
-- Move windows around workspace with mainMod + SHIFT + arrow keys
...
hl.bind("XF86MonBrightnessUp",   hl.dsp.exec_cmd("brightnessctl -e4 -n255 set 5%+"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("brightnessctl -e4 -n255 set 5%-"), { locked = true, repeating = true })
